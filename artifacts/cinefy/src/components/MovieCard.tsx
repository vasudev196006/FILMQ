...
export const MovieCard: React.FC<{
  ...
  const innerContent = (
    <TiltedCard
      ...
      showTooltip={false}
    >
      <div className="relative w-full h-full rounded-3xl overflow-hidden border border-white/15 bg-slate-950 shadow-xl" data-testid={`movie-card-${movie.id}`}>
